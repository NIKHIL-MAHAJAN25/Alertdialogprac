package com.nikhil.alertdialogprac.supa
...
class Supabase : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        supabaseClient = (applicationContext as MyApplication1).supabaseClient
...
//                                val progress = (status.totalBytesSent.toFloat() / status.contentLength * 100)
                            ...
                            is UploadStatus.Success -> {
                                ...
                                Glide.with(this@Supabase)
                                    .load(imageUrl)
                                    .placeholder(R.drawable.ic_launcher_background)
                                    .into(img)

                                Toast.makeText(this@Supabase, "Upload Successful!", Toast.LENGTH_SHORT).show()
                            }
                ...
                withContext(Dispatchers.Main) {
                    ...
                    Toast.makeText(this@Supabase, "Error uploading image: ${e.message}", Toast.LENGTH_LONG).show()
                }
            }
        }
    }
